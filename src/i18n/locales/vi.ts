...
export default {
  _nav: {
    ...
    [routes.shopDetail]: 'Thông tin cửa hàng',
  },
  ...
  updateOrderFail: 'Cập nhật đơn hàng thất bại, vui lòng thử lại sau',
  ...
  paymentRecordTitle: 'Ghi nhận thanh toán',
  customerName: 'Tên khách hàng',
  customerPhone: 'Số điện thoại',
  totalAmountPayment: 'Tổng tiền thanh toán',
